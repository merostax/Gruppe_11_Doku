...
/* package SudokuGame-1.0.0 */
#ifndef VERSION_SudokuGame
#define VERSION_SudokuGame "1.0.0"
#endif /* VERSION_SudokuGame */
#ifndef MIN_VERSION_SudokuGame
#define MIN_VERSION_SudokuGame(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_SudokuGame */
...
#define CURRENT_COMPONENT_ID "SudokuGame-1.0.0-inplace-SudokuGame"
